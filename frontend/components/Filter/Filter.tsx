...
import { IFilter, IFilterActiveColor, IFilterContext, IFilterData, IFilterElement, IFilterOrderData, IFilterPrice, IShowFilterButton } from "../../interfaces/filter.interface"
